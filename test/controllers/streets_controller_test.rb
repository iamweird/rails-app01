...
class StreetsControllerTest < ActionController::TestCase
  ...
  test "should create street" do
    assert_difference('Street.count') do
      post :create, street: { city_id: @street.city_id, district_id: @street.district_id, name: @street.name }
    end
  ...
  test "should update street" do
    patch :update, id: @street, street: { city_id: @street.city_id, district_id: @street.district_id, name: @street.name }
    assert_redirected_to street_path(assigns(:street))
  end
